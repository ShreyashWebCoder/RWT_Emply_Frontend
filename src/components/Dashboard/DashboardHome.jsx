...
const DashboardHome = () => {
  ...
  useEffect(() => {
    console.log("Current User:", employees.filter((emp) => emp.role === "employee").length);
  }, [employees]);

  const stats = [
    {
      name: "Active Employees",
      value: employees.filter((emp) => emp.role === "employee").length,
      icon: UsersIcon,
    ...
    },
    {
      ...
      value: employees.filter((emp) => emp.status === "on_leave").length,
