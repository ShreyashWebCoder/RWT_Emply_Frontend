...
//                 <div className="w-12 h-12 bg-gradient-to-br from-cyan-500 via-blue-600 to-purple-600 rounded-2xl flex items-center justify-center shadow-xl animate-pulse">
//                   <span className="text-white font-extrabold text-lg tracking-widest">
//                     EMS
//                   </span>
//                 </div>
//                 <div>
//                   <h1 className="font-bold text-xl sm:text-2xl">Saturn-X</h1>
...
//                   className="flex items-center w-full px-5 py-3 text-base font-semibold text-red-400 hover:text-white hover:bg-gradient-to-r hover:from-red-500 hover:to-red-600 rounded-2xl transition-all duration-300 group"
//                 >
