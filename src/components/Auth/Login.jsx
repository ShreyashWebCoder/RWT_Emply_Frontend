...
const Login = () => {
  ...
  const handleLogin = (e) => {
    ...
    const response = axios.post(
      "https://rwt-emp-backend.onrender.com/auth/login",
      {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-900 flex items-center justify-center p-3 sm:p-4 lg:p-6">
      ...
      >
        ...
        >
          <div className="w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24 bg-gradient-to-br from-cyan-400 via-blue-500 to-purple-600 rounded-2xl sm:rounded-3xl mx-auto mb-4 sm:mb-6 flex items-center justify-center shadow-2xl transform rotate-3 hover:rotate-0 transition-transform duration-300">
