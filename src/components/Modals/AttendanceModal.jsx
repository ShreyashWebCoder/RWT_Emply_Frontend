                ...
                <div className="block lg:hidden space-y-4">
                  {records.map((record, index) => {
                    const hours = record.punchOut
                      ? ((new Date(record.punchOut) - new Date(record.punchIn)) / (1000 * 60 * 60)).toFixed(1)
                      : "Active"
                    ...
                    return (
                      <motion.div
                        ...
                        className={`p-4 sm:p-6 rounded-2xl border ${
                          darkMode ? "bg-gray-800/50 border-gray-600/50" : "bg-white/80 border-gray-200/50"
                      ...
                      >
                        ...
                        <div className="grid grid-cols-2 gap-4 text-sm">
                          <div>
                            <p className={`font-medium ${darkMode ? "text-gray-400" : "text-gray-600"}`}>🕐 Punch In</p>
                          ...
                          <div className="col-span-2">
                            ...
                            <p className={`font-bold text-lg ${darkMode ? "text-blue-400" : "text-blue-600"}`}>
                  ...
                  <table className="w-full">
                    ...
                    <tbody>
                      {records.map((record, index) => {
                        const hours = record.punchOut
                          ?  `${(
                            (new Date(record.punchOut) - new Date(record.punchIn)) / 
                            (1000 * 60 * 60)
                          ).toFixed(1)} hours`
                          : "Active"
                        ...
                        return (
                          ...
                          >
                            ...
                            <td className={`py-4 px-6 font-bold ${darkMode ? "text-blue-400" : "text-blue-600"}`}>
                              {hours} {hours !== "Active" ? "hrs" : ""}
                            </td>
