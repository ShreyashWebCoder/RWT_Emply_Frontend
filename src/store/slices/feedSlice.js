...
export const fetchPosts = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      ...
      const response = await axios.get("https://rwt-emp-backend.onrender.com/admin/feeds",
        {
          headers: {
  ...
  async (postData, { rejectWithValue }) => {
    try {
      ...
      const response = await axios.post(
        "https://rwt-emp-backend.onrender.com/admin/feed",
        formData,
        {
          headers: {
      ...
      console.log('Post data:', {
        ...
        media: postData.media ? typeof postData.media : 'none'
      });
...
export const likePost = createAsyncThunk(
  ...
  async (postId, { rejectWithValue }) => {
    try {
      const response = await axios.put(`https://rwt-emp-backend.onrender.com/admin/feed/${postId}`);
...
export const addComment = createAsyncThunk(
  ...
  async ({ postId, comment }, { rejectWithValue }) => {
    try {
      const response = await axios.post(`https://rwt-emp-backend.onrender.com/admin/feed/comment/${postId}`, {
