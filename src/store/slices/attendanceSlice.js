...
export const punchIn = createAsyncThunk(
  ...
  async (employeeId, { rejectWithValue }) => {
    try {
      ...
      const response = await axios.post("https://rwt-emp-backend.onrender.com/admin/attendance/punch-in", { employeeId }, {
        headers: {
...
export const punchOut = createAsyncThunk(
  ...
  async (employeeId, { rejectWithValue }) => {
    try {
      const response = await axios.post("https://rwt-emp-backend.onrender.com/admin/attendance/punch-out", { employeeId });
      return response.data;
    } catch (error) {
      return rejectWithValue(error.response.data);
    }
...
export const fetchTodayAttendance = createAsyncThunk(
  ...
  async (employeeId, { rejectWithValue }) => {
    try {
      ...
      const response = await axios.get(`https://rwt-emp-backend.onrender.com/admin/attendance/today/${employeeId}`,
        {
          headers: {
            "Authorization": `Bearer ${localStorage.getItem("token")}`,
          },
...
export const fetchAttendanceRecords = createAsyncThunk(
  ...
  async (employeeId, { rejectWithValue }) => {
    try {
      const response = await axios.get(`https://rwt-emp-backend.onrender.com/admin/attendance/records/${employeeId}`,
        {
          headers: {
            "Authorization": `Bearer ${localStorage.getItem("token")}`,
          },
